...
Cliquez link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_cluster_building_blocks/beegfs_ha_building_block_cluster_1/beegfs_ha_inventory.yml["ici"^] pour un exemple de fichier d'inventaire complet.
