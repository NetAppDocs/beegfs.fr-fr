...
Pour obtenir la liste complète des paramètres pris en charge et des informations supplémentaires, veuillez consulter le link:https://github.com/NetApp/beegfs/tree/master/roles/beegfs_client["Documentation complète du client BeeGFS"^]. Pour un exemple complet d'inventaire client, cliquez link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_client/beegfs_client_inventory.yml["ici"^].
...
Pour un exemple complet de guide client, cliquez link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_client/beegfs_client_playbook.yml["ici"^].
