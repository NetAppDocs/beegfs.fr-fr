...
TIP: Voir la link:administer-clusters-overview.html["Administrer les clusters BeeGFS"] Pour plus de détails sur les termes et concepts spécifiques à l'interaction avec les clusters BeeGFS haute disponibilité (HA).
