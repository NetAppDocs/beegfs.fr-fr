...
NOTE: Si vous effectuez une mise à niveau vers BeeGFS v8, consultez plutôt la link:clusters-upgrade-beegfs-v8.html["Mise à jour vers BeeGFS v8"]procédure.
...
| 7.4.6 | 8,0 | Oui. | Mettez à niveau en suivant les instructions dans la link:clusters-upgrade-beegfs-v8.html["Mise à jour vers BeeGFS v8"] procédure. 


| 7.4.6 | 8,1 | Oui. | Mettez à niveau en suivant les instructions dans la link:clusters-upgrade-beegfs-v8.html["Mise à jour vers BeeGFS v8"] procédure. 


| 7.4.6 | 8,2 | Oui. | Mettez à niveau en suivant les instructions dans la link:clusters-upgrade-beegfs-v8.html["Mise à jour vers BeeGFS v8"] procédure. 
|===
