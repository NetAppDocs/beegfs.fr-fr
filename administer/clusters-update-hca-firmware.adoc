...
TIP: Pour les cartes Lenovo ConnectX-7, utilisez l' `mlxfwmanager_LES`outil, disponible sur la page NVIDIAlink:https://network.nvidia.com/support/firmware/lenovo-intelligent-cluster/["Micrologiciel OEM"^].
...
----
.. Redémarrez le  `eseries_nvme_ib.service` .
+
[source, console]
----
