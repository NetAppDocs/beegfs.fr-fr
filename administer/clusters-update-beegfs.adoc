...
TIP: Pour plus d'informations sur les versions BeeGFS, consultez le link:https://doc.beegfs.io/latest/advanced_topics/upgrade.html["Documentation de mise à niveau BeeGFS"^].
