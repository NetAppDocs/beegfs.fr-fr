...
NOTE: Pour connaître la taille correcte à utiliser, voir link:beegfs-deploy-recommended-volume-percentages.html["Pourcentages de surprovisionnement recommandés pour le pool de stockage"] ..
